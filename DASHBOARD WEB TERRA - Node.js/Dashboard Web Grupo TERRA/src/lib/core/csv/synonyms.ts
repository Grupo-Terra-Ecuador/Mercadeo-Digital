...
import type { SynonymKey } from "../types";

export const synonyms: Record<SynonymKey, string[]> = {
...
export function bestCol(cols: string[], type: SynonymKey): string | null {
...
export function hasCol(cols: string[], type: SynonymKey): boolean {
