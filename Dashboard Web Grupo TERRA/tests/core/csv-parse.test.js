...
import { splitRows, detectDelimiter, parseCSV } from '../../src/core/csv/parse.js';
...
describe('parseCSV', () => {
  it('salta metadatos y encuentra el encabezado real por heuristica', () => {
    ...
    // La linea en blanco del CSV de origen se descarta antes de indexar filas.
  ...
  it('no confunde una fila de datos con "iOS" como encabezado (regresion)', () => {
    // "iOS" es subcadena de "usuarios" (u-s-u-a-r-IOS): sin un largo minimo para el
    // match difuso, una fila de datos de tecnologia con valor "iOS" podia sumar puntos
    // de sinonimos de usuarios y ganarle al encabezado real.
    const csv = [
